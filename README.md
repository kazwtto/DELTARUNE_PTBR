...
A tradução em si foi feita minoritariamente por IA (cerca de 40%) e revisada manualmente por humano.
Gráficos, fontes, vídeos e demais elementos visuais foram traduzidos e editados manualmente por humano.
...
- Como a tradução do mesmo se tornou referencia, muitos nomes de monstros, itens, botões etc. foram mantidos.
...
> [!CAUTION]  
> **Aviso Legal:** Este é um projeto sem fins lucrativos, feito de fã para fã. É **terminantemente proibida** qualquer tipo de comercialização com este projeto. Todos os direitos ao **Toby Fox**.
